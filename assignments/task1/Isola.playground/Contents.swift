...
* Moving one's piece to a neighboring (horizontally, vertically, or diagonally) position that contains a square but not the opponent's 
...
![Icon](Isola_starting_position.png)
*/

let game = Isola(fieldSize: 7)

game.delegate = IsolaTracker()
